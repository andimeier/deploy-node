...
exports.processCommandLineArgs = function () {
    ...
    if (!options.project) {
        ...
        log.log('project name extracted from npm environment: ' + project);
    }
    ...
    options.deploymentFoldername = fsUtils.getPackageDirname(options.project, null, options.timestamp);

    options.buildBaseFolder = options.buildFolder;
    options.buildFolder = options.buildFolder + '/' + options.deploymentFoldername;

    options.deploymentFilename = options.deploymentFoldername + '.tar.gz';
    options.deploymentFile = options.buildBaseFolder + '/' + options.deploymentFoldername + '.tar.gz';
